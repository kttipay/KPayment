...
/**
 * Interface for managing mobile payment capabilities and configuration.
 *
 * This manager handles capability checking and configuration
 * for Google Pay and Apple Pay on mobile platforms (Android & iOS).
 *
 ...
 *
 * Use [MobilePaymentManagerImpl] for the default implementation.
 *
 * @see MobilePaymentManagerImpl
 */
interface MobilePaymentManager {
    /**
     ...
     */
    fun applePayConfig(): ApplePayMobileConfig?
}