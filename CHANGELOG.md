...
### Changed
- Dependency uplift to latest stable versions (no public API changes):
  - Compose Multiplatform `1.11.0-beta03` → `1.11.1` (off the beta line; Jetpack Compose `1.11.2` base).
  - Jetpack Compose (androidx UI tooling) `1.10.6` → `1.11.2`.
  - Kotlin `2.3.20` → `2.4.0`.
...
**Full Changelog**: https://github.com/kttipay/KPayment/compare/v0.3.0...v0.3.1
